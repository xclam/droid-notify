...
public class K9StatusBarNotificationsPreferenceActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener{
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if (_debug) Log.v("K9StatusBarNotificationsPreferenceActivity.onSharedPreferenceChanged() Key: " + key);
	...
	protected void onCreate(Bundle bundle){
	    ...
	    _debug = Log.getDebug();
	    if (_debug) Log.v("K9StatusBarNotificationsPreferenceActivity.onCreate()");
	    _context = this;
	...
	protected void onResume(){
	    if(_debug) Log.v("K9StatusBarNotificationsPreferenceActivity.onResume()");
	    super.onResume();
	    _preferences.registerOnSharedPreferenceChangeListener(this);
	}
	...
	protected void onPause(){
	    if(_debug) Log.v("K9StatusBarNotificationsPreferenceActivity.onPause()");
	    super.onPause();
	...
	private void updateVibratePreferences(){
		if (_debug) Log.v("K9StatusBarNotificationsPreferenceActivity.updateVibratePreferences()");
		try{
			...
			Log.e("K9StatusBarNotificationsPreferenceActivity.updateVibratePreferences() ERROR: " + ex.toString());
		}
	}
